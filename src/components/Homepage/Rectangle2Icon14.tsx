...
const Rectangle2Icon14 = (props: SVGProps<SVGSVGElement>) => (
  <svg preserveAspectRatio='none' viewBox='0 0 26 26' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
    <path
      ...
      fill='url(#paint0_linear_104_15)'
    />
    <defs>
      <linearGradient
        id='paint0_linear_104_15'
        x1={29.5}
        y1={-14.5}
        x2={-9.00002}
        y2={46.5}
...
const Memo = memo(Rectangle2Icon14);
export { Memo as Rectangle2Icon14 };
